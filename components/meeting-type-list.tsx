  ...
  return (
    <section className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
      <HomeCard
        ...
        className="bg-blue-1 hover:scale-105 transition-transform"
      />
      ...
      <HomeCard
        ...
        className="bg-orange-1 hover:scale-105 transition-transform"
      />
      ...
      <HomeCard
        ...
        className="bg-purple-1 hover:scale-105 transition-transform"
      />
      ...
      <HomeCard
        ...
        className="bg-[#e74c3c] hover:scale-105 transition-transform"
      />
